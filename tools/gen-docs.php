...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Notifications',
    nsPrefix: 'Milpa\\Notifications\\',
    installCommand: 'composer require milpa/notifications',
    repoUrl: 'https://github.com/getmilpa/notifications',
    pagesUrl: 'https://getmilpa.github.io/notifications/',
    heroParagraph: 'Channel-agnostic notification dispatch for the Milpa PHP framework: register channels (Telegram, Pushover, WebSocket, ...) and fan a payload out to recipients by "channel:recipient".',
    utmContent: 'notifications',
);
